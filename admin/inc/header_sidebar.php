...
.card{
            box-shadow: 0px 0px 25px 10px rgba(255,0,255,1);
	        border-radius: 20px;
...
<div class="page-container">
    <div class="page-sidebar card">
        <img alt="image" src="assets/images/mariel.png" class="KronikLogo">
        <ul class="list-unstyled accordion_menu overflow-auto element">
            ...
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                ...
                <ul>
                    <!--<li><a style="color: #fff;" <?php if ($page_title === "Ad Soyad") echo 'style="color: #83d8ae !important;"' ?> href="/adsoyad"> <img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt=""> Ad Soyad (2022)</a></li>-->
                    <li><a style="color: #fff;" <?php if ($page_title === "Ad Soyad PRO") echo 'style="color: #83d8ae !important;"' ?> href="/proadsoyad"> <img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt=""> Ad Soyad PRO</a></li>
                </ul>
            </li>
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
                ...
                <ul>
                    <li><a style="color: #fff" <?php if ($page_title === "Mernis 2022+ ") echo 'style="color: #fff !important;"' ?> href="/promernis2022"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">2022 PRO</a></li>
                    <li><a style="color: #fff" <?php if ($page_title === "kmlik ön arka ") echo 'style="color: #fff !important;"' ?> href="/wizortkimlik"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">kimlik ön arka</a></li>
                    <li><a style="color: #fff" <?php if ($page_title === "Seri No") echo 'style="color: #83d8ae !important;"' ?> href="/serino"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Seri No Sorgu</a></li>
                    <li><a style="color: #fff" <?php if ($page_title === "Aile Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/aile"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Aile Sorgu</a></li>
                    <li><a style="color: #fff" <?php if ($page_title === "Aile Sorgu v2 ") echo 'style="color: #000000 !important;"' ?> href="/v2aile"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Aile Sorgu v2</a></li>
                    <!--<li><a style="color: #fff" <?php if ($page_title === "Tapu Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/tapu"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Tapu Sorgu</a></li>-->
                    <li><a style="color: #fff" <?php if ($page_title === "TC İşyeri") echo 'style="color: #83d8ae !important;"' ?> href="/tcisyeri"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt=""></i>İşyeri Sorgu</a></li>
            ...
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                ...
                <ul>
                    <li><a style="color: #fff;" <?php if ($page_title === "TC GSM Plus") echo 'style="color: #fff !important;"' ?> href="/gsmplus"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">TC'den GSM Plus</a></li>
                    <li><a style="color: #fff;" <?php if ($page_title === "TC GSM") echo 'style="color: #fff !important;"' ?> href="/tcgsm"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">TC'den GSM</a></li>
                </ul>
            </li>
            <!--<li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid"  <?php
                if (
                ...
                <ul>
                    li><ae="color: #fff !important;" <?php if ($page_title === "Vesikalık Sorgu") echo 'style="color: #fff !important;"' ?> href="/vesikalik"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Vesikalık Sorgu</a></li>
                </ul>
            </li>-->
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
                ...
                <ul>
                    <li><a style="color:#fff;" <?php if ($page_title === "TC Okul") echo 'style="color: #83d8ae !important;"' ?> href="/tcokul"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Okul Sorgu</a></li>
                    ...
                    <li><a style="color:#fff;" <?php if ($page_title === "Sınıf Sorgu") echo 'style="color: #83d8ae !important;"' ?> href="/sinif"><img style="width: 15px; margin-right: 5px" src="assets/images/mariel.png" alt="">Sınıf Sorgu</a></li>
                </ul>
            </li>
            <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
                if (
                ...
                <ul>
                    <li><a style="color:#fff;" <?php if ($page_title === "Mernis 2015") echo 'style="color: #83d8ae !important;"' ?> href="/mernis2015"><img style="width: 15px; margin-right: 5px" alt="">2015 Sorgu</a></li>
                    <li><a style="color:#fff;" <?php if ($page_title === "Facebook") echo 'style="color: #83d8ae !important;"' ?> href="/facebook"><img style="width: 15px; margin-right: 5px" " alt="">Facebook Sorgu</a></li>
                    <li><a style="color:#fff;" <?php if ($page_title === "GSM TC") echo 'style="color: #83d8ae !important;"' ?> href="/gsmtc"><img style="width: 15px; margin-right: 5px"  alt="">GSM'den TC</a></li>
                </ul>
            </li>
            <?php if ($k_rol === "1") { ?>
                <li style="border-radius: 2px; margin-bottom:3px; border-top-style:solid" <?php
