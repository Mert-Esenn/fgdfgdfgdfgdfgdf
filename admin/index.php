...
<div class="content py-3">
  <div class="row fs-sm">
    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
      edit <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="Kronik.org" target="_blank"> @xbus5e </a>
    </div>
    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
      <a class="fw-semibold" href="Kronik.org" target="_blank">MARİEL 1.0</a> © <span data-toggle="year-copy" class="js-year-copy-enabled">2021 - 2022</span>
    </div>
  </div>
</div>
